...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--dropout', default=0.25, type=float, help='dropout rate')
        self.parser.add_argument('-norm', '--norm', default=0.01, type=float, metavar='N',
                                 help='constraint  of sparsity')
        self.parser.add_argument('--n_head', type=int, default=8, help='num head')
        self.parser.add_argument('--dim_model', type=int, default=256, help='dim model')
        ...
        self.parser.add_argument('-b','--batch_size', type=int, default=256, help='can be changed depending on your machine')
